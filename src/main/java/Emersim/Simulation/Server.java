...
import Emersim.Map.APIErrorDialog;
import Emersim.Map.ClientGraphic;
import Emersim.Map.DirectionsNotFoundException;
import Emersim.Map.MapConfig;
import Emersim.Utils.LatLngUtils;
...
public class Server {
    ...
    private void calculateResponseTime(Request request, boolean returnJourney) {
